...
export default function VideoLibrary({ library, apiKey, isLoadingLibrary, onRefresh }: VideoLibraryProps) {
  return (
    <div className="mt-12 bg-gray-50 dark:bg-zinc-900 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-zinc-800">
      ...
      {library.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {library.map((video) => (
            <VideoCard key={video.id} video={video} apiKey={apiKey} onDelete={onRefresh} />
          ))}
        </div>
      )}
    </div>
